			...
			if (code == undefined){
				...
				if(db.user[userID].auth == undefined){
					...
					if (typeof out == 'string'){
						...
						.addField('1. Please click the `sign in with google button` to get your OAuth2 code',`[![Sign in with google](https://walksanatora.github.io/PondoBot/google_signin.png "Sign in with google")](${out})`,false)
