			...
			if (code == undefined){
				...
				if(db.user[userID].auth == undefined){
					...
					if (typeof out == 'string'){
						...
						.addField('1. Please click the `sign in with google button` to get your OAuth2 code',`![Signin w/ Google Image](https://walksanatora.github.com/PondoBot/google_signin.png)\n[Sign in with google](${out})`,false)
